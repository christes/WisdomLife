...
#import "NMGCDTimerManager.h"

@interface NMGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation NMGCDTimerManager

#pragma mark - Public Method

+ (NMGCDTimerManager *)sharedInstance{
    static NMGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[NMGCDTimerManager alloc] init];
    });
